            ...
            <div class="col-8 col-md-6 background-lilac-52">
                <div class="center">
                    ...
                    <form action="{{ route('genres.update', ['genre' => $genre->id]) }}" method="post">
                        ...
                        @method('PUT')
                        <div>
                            <label for="genre"><b>Название:</b></label><br> <br>
                            <input type="text" placeholder="Название" name="genre"
                                class=" @error('genre') is-invalid @enderror" id="genre" value="{{ $genre->genre  }}">
                            <input type="submit" value="Изменить" class="margin-top-20">
                        </div>
                    </form>
                    <div class="right"><a href="{{ route('genres.show',  ['genre' => $genre->id]) }}">Назад</a></div>
                </div>
            </div>
            <div class="col-2 col-md-3"></div>
        </div>
