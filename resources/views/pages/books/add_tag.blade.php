            ...
            <div class="row">
                ...
                <div class="col-8 col-md-6 background-lilac-52">
                    <div class="center">
                        ...
                        @endif
                        <form action="{{ route('books.store_tag', ['book' => $book->id]) }}" method="post">
                            @csrf
                        
                            <x-input-label for="tag_id" :value="__('Id тега')" />
                            <x-text-input id="tag_id" type="text" name="tag_id" required />
