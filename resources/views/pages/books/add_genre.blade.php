...
<main>
    ...
    <div class="container">
        @if(Auth::user()->role_id == 2)
            <div class="row">
                <h3 class="center">Добавить жанр</h3>
            </div>
            <div class="row">
                ...
                <div class="col-8 col-md-6 background-lilac-52">
                    <div class="center">
                        ...
                        @endif
                        <form action="{{ route('books.store_genre', ['book' => $book->id]) }}" method="post">
                            @csrf
                        
                            <x-input-label for="genre_id" :value="__('Id жанра')" />
                            <x-text-input id="genre_id" type="text" name="genre_id" required />
