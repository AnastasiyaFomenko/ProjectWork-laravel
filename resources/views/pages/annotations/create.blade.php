            ...
            <div class="col-8 col-md-6 background-lilac-52">
                <div class="center">
                    ...
                    <form action="{{ route('annotations.store') }}" method="post">
                        @csrf
                        <div>
                            <label for="annotation"><b>Название:</b></label><br>
                            <input type="text" placeholder="Название" name="annotation"
                                class=" @error('annotation') is-invalid @enderror" id="annotation">
                            <input type="submit" value="Добавить" class="margin-top-20">
                        </div>
                    </form>
                    <div class="right"><a href="{{ route('annotations.index') }}">Назад</a></div>
                </div>
            </div>
            <div class="col-2 col-md-3"></div>
        </div>
